...
list.of.packages <- c("ggplot2", "dplyr", "gdata", "tidyr", "grid", "gridExtra", "Rcpp", "R.devices", "httpgd")
...
rotated_axis_text <- function() {
  theme(axis.text.x = rotatedAxisElementText(x_axis_rotation, "x"), axis.text.y = rotatedAxisElementText(y_axis_rotation, "y"))
}
